...
class GesturesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let rotate = UIRotationGestureRecognizer(target: self, action: "rotatedView:")
        rotateView.addGestureRecognizer(rotate)
        
        let longPressed = UILongPressGestureRecognizer(target: self, action: "longPressedView:")
        longPressView.addGestureRecognizer(longPressed)
        
        
    }
    @IBAction func swipedView(sender: UISwipeGestureRecognizer) {
        print("swiped")
